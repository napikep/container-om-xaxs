...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-om-xaxs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-om-xaxs.containers.anotherwebservice.com/
...
```
git clone git@github.com:napikep/container-om-xaxs.git
cd container-om-xaxs
```
...
```
docker attach container-om-xaxs
```
